...
import numpy as np
from mtdnc.data.utils.batch_generator import BatchGenerator

from mtdnc.data.tasks.repeat_copy import CopyTask
from mtdnc.data.tasks.cnn_rc import ReadingComprehension
from mtdnc.data.tasks.babi import bAbI
