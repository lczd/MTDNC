...
from mtdnc.model.memory_units.base_cell import BaseMemoryUnitCell
...
class DNCMemoryUnitCell(BaseMemoryUnitCell):
    ...
    @staticmethod
    def _update_write_weighting(alloc_weighting, write_gate, alloc_gate):

        write_weighting = write_gate * alloc_weighting
